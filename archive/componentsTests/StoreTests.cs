...
namespace components.Tests
{
    ...
    public class StoreTests
    {
        ...
        public void ProcessCardTransactionIntegrationTest()
        {
            ...
            {
                csca5028.TransactionProcessor.CreditCardProcessor processor = new csca5028.TransactionProcessor.CreditCardProcessor("http://localhost:9001", new System.Net.Http.HttpClient());
                var response = store.ProcessCardTransaction(sale, processor);
                Assert.IsTrue((response.ResponseType == CreditCardResponseTypes.AUTH) || (response.ResponseType == CreditCardResponseTypes.DECLINE));
