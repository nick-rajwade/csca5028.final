...
namespace csca5028.web_app.Data
{
    public class KanbanDataModels
    {
        ...
        public List<KanbanDataModels> GetTasks()
        {
        ...
        public List<KanbanDataModels> GetCardTasks()
        {
            ...
            CardData.Add(new KanbanDataModels { Id = "Task 14", Title = "Task  - 29022", Status = "Close", Summary = "Analyze stored procedure.", Priority = "Critical", Tags = "CustomSample, Customer", RankId = 4, Assignee = "Janet Leverling" });
        ...
        public List<KanbanDataModels> GetPizzaData()
        {
        ...
        public List<KanbanDataModels> StatusData()
        {
            ...
            StatusDropDown.Add(new KanbanDataModels { ListId = 2, Value = "Testing" });
