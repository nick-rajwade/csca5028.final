...
namespace saleswebapp.Controllers
{
    ...
    {
        public IActionResult PresentationFeatures()
        {
          return View();
        }
        [HttpPost]
        public IActionResult GeneratePresentation()
        {
	...
	# region Slide
        private void CreateDefaultSlide(IPresentation presentation)
        {
            ...
            ISlide slide1 = presentation.Slides.Add();
            ...
            (slide1.Shapes[1] as IShape).Top = 215;
            (slide1.Shapes[1] as IShape).Width = 720;
            (slide1.Shapes[1] as IShape).Left = 120;
            (slide1.Shapes[1] as IShape).Height = 130;
